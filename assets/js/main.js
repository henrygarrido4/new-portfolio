...
(function ($) {
  ...
  if ($("#tp-3d-slide-wrapper").length > 0) {
    var Slider = (function () {
      var initSlider = function () {
        ...
        var swipeHandler = new Hammer(
          document.getElementById("tp-3d-slide-wrapper")
        );
        ...
        $(".tp-3d-slide-arrow-right , .tp-3d-slide-arrow-left").click(function (
          event
        ) {
  ...
  inputFields.each(function (e) {
    ...
    if ($this.val().length === 0) {
      $this
        .closest(".postbox__comment-input")
        .find(".floating-label, .floating-label-2")
        .removeClass("floating-label-floated");
    } else {
      $this
        .closest(".postbox__comment-input")
        .find(".floating-label, .floating-label-2")
        .addClass("floating-label-floated");
    }
  });

  $(".postbox__comment-input input, .postbox__comment-input textarea").on(
    "focus",
    function () {
      var $this = $(this);
      $this
    ...
    if ($(window).width() > 1199) {
      ...
      if ($("#pagepiling").length > 0) {
        $("#pagepiling").pagepiling({
          menu: "#onePageMenu",
          anchors: ["cases", "skills", "about", "projects", "contact"],
          navigation: {
            position: "right",
            tooltips: [
              "Cases",
  ...
  $(".tp-project-5-title-wrap .tp-project-5-title-box").on(
    "mouseenter",
    function () {
